...
- **[PER Coding Standard](https://www.php-fig.org/per/coding-style/)** - The easiest way to apply the conventions is to install [PHP Code Sniffer](https://pear.php.net/package/PHP_CodeSniffer).
